...
import type {
  ...
  QueryResult,
  MigrationDefinition,
} from '../../../shared/src/services/StorageService/DataStore.types';
...
export class DatabaseService implements IDataStore {
  ...
  async getSessionStatistics(): Promise<import('../../../shared/src/types').ReadingStats> {
    return getAPI()('getSessionStatistics') as Promise<import('../../../shared/src/types').ReadingStats>;
  }
