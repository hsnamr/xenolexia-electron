...
import type { RootStackScreenProps } from '@xenolexia/shared/types/navigation';
import type { ForeignWordData } from '@xenolexia/shared/types/index';
...
} from '@xenolexia/shared/stores/readerStore';
...
export function ReaderScreen(): React.JSX.Element {
  ...
  // Handle word hover end (desktop)
  const handleWordHoverEnd = useCallback(() => {
    if (handleWordHoverEnd) {
      handleWordHoverEnd();
    }
  }, []);
