...
import { getLanguageInfo, SUPPORTED_LANGUAGES } from '@xenolexia/shared/types/index';
import type { RootStackParamList, Language, ProficiencyLevel } from '@xenolexia/shared/types/index';
